...
public interface DeviceMapper {
    ...
    @Insert("INSERT INTO `smartpi`.`device`(`name`, `group_id`, `ascription`, `ip`, `auto_control`, `create_time`, `remark`) VALUES (#{name},#{groupId},#{ascription},#{ip},#{autoControl},#{createTime},#{remark});")
