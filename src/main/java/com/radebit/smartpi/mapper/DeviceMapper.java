...
public interface DeviceMapper {
    ...
    @Insert("INSERT INTO `smartpi`.`device`(`name`, `group_id`, `ascription`, `star`, `ip`, `auto_control`, `create_time`, `last_online_time`, `remark`, `cover_img`, `is_online`) VALUES (#{name},#{groupId},#{ascription},#{star},#{ip},#{autoControl},#{createTime},#{lastOnlineTime},#{remark},#{coverImg},#{isOnline});")
